...
public class ExcelRankingController {
    ...
    @Operation(summary = "El ranking en un .xlsx de UNA hoja llamada «Datos», con los "
            ...
            + "rúbrica es una columna; en PRUEBA_PUESTO son los de la prueba que la vacante "
            + "tiene puesta hoy, aunque alguien haya rendido otra versión —sus notas van en "
            + "«Justificación detallada»—. La columna CV lleva un enlace firmado que abre el "
