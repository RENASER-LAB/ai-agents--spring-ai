...
public class Evaluacion {
    ...
    /** NULL solo en el cuestionario técnico de una vacante, que no tiene plantilla (V44). */
    private Long plantillaEvaluacionId;
    /**
     * La versión del banco con la que se mide este examen.
     *
     * <p>⚠️ El nombre se quedó corto en la V44: con el cuestionario técnico aquí vive un banco
     ...
     *  postulación cuelga y qué barrido lo cierra (V44). */
    @Builder.Default
    private String proposito = "PERFIL_INTEGRAL";
    /** Los minutos con los que nació, congelados al crearlo. NULL = los del instrumento (V44). */
